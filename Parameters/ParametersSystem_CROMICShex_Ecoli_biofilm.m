...
grid_sh='h';         %h=Hexagonal grid,  s=Square grid
...
DataFile=strcat('./Data/dataForCROMICShex_Ecoli_biofilm.mat')
%Name that will be used to save the results (include the path, it is suggested to use the folder "Results" ):   
ResultsFile=strcat('./Results/resultsCROMICShex_Ecoli_biofilm');
