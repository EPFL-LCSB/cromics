function []=CROMICSsq_SPT_launch(rep,cA,nameDataFile)
...
if addEPS==1
    [frac,VavLBM]=PavailableSpace_EPS(v_met,fepsCell1,v_met,CellSizeVar,Vcell_cte,vol_lbm,v_sp,fwater,IDpos,Ny_lbm,Nx_lbm,Nz_lbm,num_met,frac_medium,Ncells,frac*0);
else
...
for contt=2:floor(tsim/At)+1
    ...
    if contt<timeInert
        ...
        if strfind(pde_method,'LBM')==1 
            [rhoLBM_met,flux_bio,flux,IDpos,r2t_met]=cLBM_aTFA_SPT(FD,cA,num_sp,indCsat,rD_ind,Csat,r2t_met,metlbm,AvN,Ax_lbm,IDlbm,frac,W,Prob,Q,FBD,aQ1,Nx_lbm,Ny_lbm,Nz_lbm,time_lbm,Vmt,At_lbm,Ncells,num_met,rhoLBM_met,VavLBM,maxMcell,IDpos,n,Vmax,Km,VmaxDiff,vshrinkage,num_metInert,cellDist,frac_medium,vol_lbm,num_eps,dens,dens_int,r,rint,Rmet,P_kT,vff,NNlist,GEMs);

        else %pde_method='CN' 
            [rhoLBM_met,flux_bio,flux,IDpos]=CN_aTFA_SPT(FD,indCsat,rD_ind,Csat,metlbm,AvN,frac,FBD,Nx_lbm,Ny_lbm,Nz_lbm,time_lbm,Vmt,At_lbm,Ncells,num_met,rhoLBM_met,VavLBM,maxMcell,IDpos,Vmax,Km,VmaxDiff,vshrinkage,num_metInert,a1y,c1y,a1x,c1x,a1z,c1z,b1y,b2y,b1x,b2x,b1z,b2z,ap1x,cp1x,ap1y,cp1y,ap1z,cp1z,CNx,CNy,CNz,lambda_x,lambda_y,lambda_z,n,num_sp,cellDist,frac_medium,vol_lbm,num_eps,dens,dens_int,r,rint,Rmet,P_kT,vff,NNlist,GEMs);
        end    
    end
