...
load Ecoli_glc_ac_o2_aTFA.mat
model.var_ub(ismember(model.varNames,strcat('R_DM_lcts_e')))=0; 
...
Vmax=[10;15;17;0];%[mmol gDW^-1 h^-1] %v3
...
nameFile='TestPoints_Ecoli_glc_paTFA_45K.mat'
